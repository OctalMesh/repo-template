...
1. Click **Use this template** on GitHub to create a new repository.
   ![Use this template button](./.github/assets/btn_use_this_template.png)
2. Use the **Owner** dropdown to select the OctalMesh organization or your
   personal account as the owner of the new repository.
   ![Owner dropdown menu](./.github/assets/dd_repo_owner.png)
3. Fill in the **Repository name** and optionally the **Description** for the
   new repository.
   ![Repository name and description](./.github/assets/field_repo_name_desc.png)
4. Choose to make the repository **Public** or **Private**.
   ![Public or Private repository](./.github/assets/dd_repo_visibility.png)
5. Optionally, to include the directory structure and files from all branches in
   ...
   branches**.
   ![Include all branches toogle switch](./.github/assets/tgs_include_all_branches.png)
...
<h6 align="center">
  OctalMesh Repository Template - a clean starting point for every project.<br />
